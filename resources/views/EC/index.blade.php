                        ...
                        <div class="row">
                            <div class="col-6 ">
                                <label>Filter Tanggal</label>
                                  <input type="text" id="date-ec" data-config="" class="form-control">
                            </div>
                            <div class="col-6">
                         ...
                         @endcan
                           ...
                           <div class="table-responsive">
                               <table id="datatable-ec"
                                   class="table border table-striped table-bordered text-nowrap" style="width:100%" data-jabatan="{{ $jabatan }}">
                                   <thead>
                                       <tr>
                                        @can('access', ['Manager'])   
